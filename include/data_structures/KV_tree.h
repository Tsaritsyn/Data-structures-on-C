 ...
 *
 * This structure contains pointers to elements considered key and values. Keys must be comparable in the sense that
...
/**
 * Frees the memory allocated for the given node. The key and data elements will also be destroyed.
 *
...
/**
 * Copies all the content from one node to another. The source node and all its data elements will remain intact.
 *
 ...
 * @param compare_keys function that will compare_numerical the key elements to put the pair into the right place
 ...
 * Balances the tree.
 *
 * @param compare_keys function that will compare_numerical the key elements given pointers to them
